        ...
        <div class="overflow box-bordered mr-t-10" style="max-height: 75vh">
            ...
            <?php
                ...
                ?>
                            ...
                            <tr>
                                <td>
                                    <a href="coveragearea-delete.php?id=<?php echo $id;?>"><i class="fa fa-minus-square text-danger pointer remove-coverage" title="Remove"></i></a>
                                    <a href="coveragearea-update.php?id=<?php echo $id;?>"><i class="fa fa-edit text-info pointer remove-coverage" title="Edit"></i></a>
                                </td>
                                <td><?php echo $id;?></td>
                                <td><?php echo $name;?></td>
